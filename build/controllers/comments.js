...
router.get('/', asyncMiddleware(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var queryObject, comments;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                queryObject = {};
                // zeby supplier byl importowany
                console.log(supplier_1.Supplier);
                if (req.query.product && mongoose_1.default.Types.ObjectId.isValid(req.query.product)) {
                    queryObject.product = req.query.product;
                }
                return [4 /*yield*/, comment_1.default.find(queryObject).populate("product")];
            case 1:
                comments = _a.sent();
                res.send(comments);
                return [2 /*return*/];
